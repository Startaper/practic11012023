...
def load_sliced_sprites(w, h, filename):
    images = []
    master_image = pygame.image.load(os.path.join('image', filename)).convert_alpha()
...
nebula = pygame.image.load(os.path.join('image', 'bg.png'))

explosion_images = load_sliced_sprites(128, 128, 'explosion_slice.png')
explosion_info = ImageInfo([64, 64], [128, 128], 64, 7, True)

ship_image = pygame.image.load(os.path.join('image', 'ship.png'))
ship_info = ImageInfo([45, 45], [90, 90], 45)

thrusted_ship_image = pygame.image.load(os.path.join('image', 'ship_start.png'))
thrusted_ship_info = ImageInfo([45, 45], [90, 90], 45)

rock_image = pygame.image.load(os.path.join('image', 'asteroid.png'))
rock_info = ImageInfo([45, 45], [90, 90], 45)

missile_image = pygame.image.load(os.path.join('image', 'shell.png'))
missile_info = ImageInfo([5, 5], [10, 10], 5, 50)

splash = pygame.image.load(os.path.join('image', 'splash.png'))
